...
append_data("test/test_date.csv", data=[1,2,3,4], datetime=datetime.utcnow())
append_data("test/test_no_date.csv", data=[1,2,3,4,5], datetime=None)
append_data("test/test_single_value.csv", data=2, datetime=datetime.utcnow())